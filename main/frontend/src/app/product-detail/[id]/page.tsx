...
const productDatabase: Record<string, ProductData> = {
  '1': {
    ...
    images: [
      { src: '/img/gucci-sneaker.jpg', alt: 'Angle 1 - Gucci Sneaker' },
      { src: '/img/addidas samba.jpg', alt: 'Angle 2 - Samba Alternative' },
      { src: "/img/Nike men's summer sneaker (men shoe collection for 2024).jpg", alt: 'Angle 3 - Sneaker Collection' },
      { src: '/img/fashion mood board.jpg', alt: 'Angle 4 - Moodboard' }
    ],
    colors: [
  ...
  '2': {
    ...
    images: [
      { src: '/img/gucci-runway.jpg', alt: 'Angle 1 - Runway Jacket' },
      { src: '/img/Oversized ripped balenciaga jacket.jpg', alt: 'Angle 2 - Denim Jacket' },
      { src: '/img/sample-velora.jpg', alt: 'Angle 3 - Hoodie' },
      { src: '/img/fashion mood board.jpg', alt: 'Angle 4 - Fabric Detail' }
    ],
    colors: [
  ...
  '3': {
    ...
    images: [
      { src: '/img/sample-velora.jpg', alt: 'Angle 1 - Model Front' },
      { src: '/img/Adidas sakura zip up hoodie.jpg', alt: 'Angle 2 - Product Flat' },
      { src: '/img/Oversized ripped balenciaga jacket.jpg', alt: 'Angle 3 - Styling' },
      { src: '/img/fashion mood board.jpg', alt: 'Angle 4 - Fabric Detail' }
    ],
    colors: [
...
export default function ProductDetailPage() {
  ...
  const idStr = String(params?.id || '3');
  const prod = productDatabase[idStr] || {
    ...productDatabase['3'],
    id: idStr
  };
  ...
  useEffect(() => {
    setActiveImage(prod.images[0].src);
    setActiveColor(prod.colors[0].name);
    setActiveSize(prod.sizes[1] || prod.sizes[0]);
  }, [prod]);
          ...
          <div id="tab-details" className="tab-pane-content active">
            <div className="tab-split-grid">
              ...
              <div className="tab-visual-banner">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/img/fashion mood board.jpg" alt="Craftsmanship Detail" />
        ...
        <div className="related-grid">
          ...
          <Link href="/product-detail/6" className="related-card" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="related-img-box">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/img/Adidas sakura zip up hoodie.jpg" alt="Adidas Sakura Hoodie" loading="lazy" />
          ...
          <Link href="/product-detail/4" className="related-card" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="related-img-box">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/img/Balenciaga Track 4_0 570391 W2GN7 2009.jpg" alt="Balenciaga Track 4.0" loading="lazy" />
              <button className="btn-card-wishlist" title="Yêu thích" type="button">♡</button>
            </div>
            <div className="related-info">
          ...
          <Link href="/product-detail/5" className="related-card" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="related-img-box">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/img/Oversized ripped balenciaga jacket.jpg" alt="Oversized Balenciaga Jacket" loading="lazy" />
              <button className="btn-card-wishlist" title="Yêu thích" type="button">♡</button>
            </div>
            <div className="related-info">
          ...
          <Link href="/product-detail/7" className="related-card" style={{ textDecoration: 'none', color: 'inherit' }}>
            <div className="related-img-box">
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src="/img/addidas samba.jpg" alt="Adidas Samba" loading="lazy" />
              <button className="btn-card-wishlist" title="Yêu thích" type="button">♡</button>
            </div>
            <div className="related-info">
