...
export default function LoginPage() {
  ...
  const handleRegisterSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    showToast(`Chào mừng ${regName}! Tài khoản Aethelgard đã tạo thành công.`);
    setActiveTab('login');
  };
            ...
            >
              <div className="dual-col">
                <img
                  ...
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = '/img/1.jpg';
                  }}
                />
              </div>
              <div className="dual-col">
                <img
                  ...
                  className="dual-col-img"
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = '/img/2.jpg';
                  }}
                />
              </div>
            </div>
